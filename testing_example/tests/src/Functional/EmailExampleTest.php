...
class EmailExampleTest extends ExamplesBrowserTestBase {
   ...
   *
   * - A link to the testing_example in the Tools menu.
   * - That you can successfully access the testing_example page.
   */
  public function testEmailExampleBasic() {
    ...
    // Verify if we can successfully access the testing_example page.
    ...
    $this->assertMailString('body', "\n--\nMail altered by testing_example module.", 1);
  }
