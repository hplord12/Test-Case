...
/**
 * Tests for the testing_example module.
 *
 ...
 */
class DbtngExampleTest extends BrowserTestBase {
...
/**
  ...
  /**
   * Regression test for testing_example.
   *
  ...
  public function testDbtngExample() {
    ...
    // Assert that two entries were inserted at install.
    $result = $this->container->get('testing_example.repository')->load();
  ...
  protected function providerMenuLinks() {
    return [
      ...
      '/examples/dbtng-example' => ['/examples/dbtng-example/add','/examples/dbtng-example/update','/examples/dbtng-example/advanced'],
    ];
  }
  ...
  public function testUi() {
    ...
    $result = $this->container->get('testing_example.repository')->load(['surname' => 'Anonymous']);
    $this->drupalGet('/examples/dbtng-example');
