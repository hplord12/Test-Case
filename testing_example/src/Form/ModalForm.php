 ...
 * the \Drupal\testing_example\Controller\Page page controller loads the Drupal
...
class ModalForm extends FormBase {
  ...
  public function getFormId() {
    return 'testing_example_modal_form';
  }
  ...
  public function buildForm(array $form, FormStateInterface $form_state, $nojs = NULL) {
    ...
    if ($nojs == 'nojs') {
      ...
      $form['use_ajax_container']['use_ajax'] = [
        ...
        '#url' => Url::fromRoute('testing_example.modal_form', ['nojs' => 'ajax']),
        '#attributes' => [
          'class' => ['use-ajax'],
