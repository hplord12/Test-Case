...
namespace Drupal\testing_example\Form;

use Drupal\Core\Form\FormBase;
use Drupal\Core\Form\FormStateInterface;
use Drupal\testing_example\DbtngExampleRepository;
...
class DbtngExampleUpdateForm extends FormBase {
   ...
   *
   * @var \Drupal\testing_example\DbtngExampleRepository
   */
  ...
  public static function create(ContainerInterface $container) {
    $form = new static($container->get('testing_example.repository'));
  ...
  public function buildForm(array $form, FormStateInterface $form_state) {
    ...
    if (empty($entries)) {
      $form['no_values'] = [
        '#value' => $this->t('No entries exist in the table testing_example table.'),
      ];
      return $form;
    }
